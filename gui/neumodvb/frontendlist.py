    ...
    all_columns = \
        [CD(key='adapter_name',  label='adapter', basic=True, no_combo=True, readonly=True,
         ...
         CD(key='fe_enable_menu',  label='enable', basic=False, cfn=enable_cfn, dfn=enable_dfn, sfn=enable_sfn,
            example=" DVB T+C "),
         CD(key='priority',  label='prio', basic=True),
         CD(key='sub.bbframes_on',  label='bbf\non', basic=True, readonly=True),
         ...
         CD(key='supports.bbframes',  label='bbf\nsup', basic=True, dfn=bool_fn, readonly=True),
