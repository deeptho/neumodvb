...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.0pre on Sun Dec 10 23:01:26 2023
#
...
class SchedulingParameters_(wx.Panel):
				def __init__(self, *args, **kwds):
								...
								grid_sizer_6 = wx.FlexGridSizer(1, 2, 0, 5)
								grid_sizer_2.Add(grid_sizer_6, 1, wx.FIXED_MINSIZE, 0)

								self.interval_text_ctrl = DtIntCtrl(self, wx.ID_ANY, "")
								grid_sizer_6.Add(self.interval_text_ctrl, 0, 0, 0)

								from neumodvb.neumowidgets import RepeatTypeChoice
								self.repeat_type_choice = RepeatTypeChoice(self, wx.ID_ANY, choices=[_("Scan spectrum"), _("Scan Muxes")])
								self.repeat_type_choice.SetToolTip(_("When to repeat the job "))
								self.repeat_type_choice.SetSelection(1)
								grid_sizer_6.Add(self.repeat_type_choice, 0, wx.BOTTOM, 4)
...
class ScanParameters_(wx.Panel):
				def __init__(self, *args, **kwds):
								...
								grid_sizer_3.Add(self.panel_2, 1, wx.ALL | wx.EXPAND, 0)

								grid_sizer_4 = wx.GridSizer(1, 1, 0, 0)

								self.allowed_sat_bands_checklistbox = SatBandsCheckListBox(self.panel_2, wx.ID_ANY, choices=[])
								grid_sizer_4.Add(self.allowed_sat_bands_checklistbox, 0, 0, 0)

								self.panel_3 = wx.Panel(self, wx.ID_ANY, style=wx.BORDER_SUNKEN)
								grid_sizer_3.Add(self.panel_3, 1, wx.ALL | wx.EXPAND, 0)

								grid_sizer_7 = wx.GridSizer(1, 1, 0, 0)

								self.allowed_pols_checklistbox = PolarisationsCheckListBox(self.panel_3, wx.ID_ANY, choices=[])
