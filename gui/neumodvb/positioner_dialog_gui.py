...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.0pre on Wed Jan 19 20:29:28 2022
#
...
class SignalPanel_(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        label_15 = wx.StaticText(self, wx.ID_ANY, _("ISI:"))
        isi_sizer.Add(label_15, 0, wx.ALIGN_CENTER_VERTICAL, 0)
...
class TuneMuxPanel_(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.has_pat = wx.StaticText(self.si_info_panel, wx.ID_ANY, _("PAT"))
        self.has_pat.SetForegroundColour(wx.Colour(255, 0, 0))
        si_status_sizer.Add(self.has_pat, 0, 0, 0)

        self.has_nit = wx.StaticText(self.si_info_panel, wx.ID_ANY, _("NIT"))
        self.has_nit.SetForegroundColour(wx.Colour(255, 0, 0))
        si_status_sizer.Add(self.has_nit, 0, 0, 0)

        self.has_sdt = wx.StaticText(self.si_info_panel, wx.ID_ANY, _("SDT"))
        self.has_sdt.SetForegroundColour(wx.Colour(255, 0, 0))
        si_status_sizer.Add(self.has_sdt, 0, 0, 0)

        self.has_fail = wx.StaticText(self.si_info_panel, wx.ID_ANY, "")
        self.has_fail.SetForegroundColour(wx.Colour(255, 0, 0))
        si_status_sizer.Add(self.has_fail, 0, 0, 0)

        self.has_si_done = wx.StaticText(self.si_info_panel, wx.ID_ANY, "")
        self.has_si_done.SetForegroundColour(wx.Colour(0, 0, 255))
        si_status_sizer.Add(self.has_si_done, 0, 0, 0)
        ...
        self.si_symbolrate_text_copy = wx.StaticText(self.si_info_panel, wx.ID_ANY, "")
        grid_sizer_15.Add(self.si_symbolrate_text_copy, 0, wx.EXPAND, 0)
...
class PositionerDialog_(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        grid_sizer_18.Add(self.continuous_motion_panel, 1, wx.EXPAND, 0)

        sizer_10 = wx.BoxSizer(wx.VERTICAL)

        label_20 = wx.StaticText(self.continuous_motion_panel, wx.ID_ANY, _("Limits"))
        label_20.SetFont(wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        sizer_10.Add(label_20, 0, wx.BOTTOM, 3)

        grid_sizer_10 = wx.GridSizer(1, 3, 8, 8)
        ...
        label_18 = wx.StaticText(self.drive_rotor_panel, wx.ID_ANY, _("Drive motor"))
        ...
        self.goto_east_button = wx.Button(self.drive_rotor_panel, wx.ID_ANY, _("Go East"))
        ...
        grid_sizer2.Add(self.goto_east_button, 0, 0, 0)

        self.goto_ref_button = wx.Button(self.drive_rotor_panel, wx.ID_ANY, _("Go Ref"))
        ...
        self.goto_west_button = wx.Button(self.drive_rotor_panel, wx.ID_ANY, _("Go West"))
        ...
        grid_sizer2.Add(self.goto_west_button, 0, 0, 0)
        ...
        label_12 = wx.StaticText(self.usals_location_panel, wx.ID_ANY, _("USALS parameters"))
        ...
        grid_sizer_5.Add(self.lattitude_text_ctrl, 0, wx.ALIGN_CENTER_VERTICAL | wx.FIXED_MINSIZE | wx.RIGHT, 0)
        ...
        grid_sizer_5.Add(self.longitude_text_ctrl, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.FIXED_MINSIZE | wx.RIGHT, 0)
        ...
        grid_sizer_19 = wx.FlexGridSizer(1, 2, 0, 5)
        sizer_8.Add(grid_sizer_19, 1, wx.EXPAND, 0)

        label_2 = wx.StaticText(self.usals_location_panel, wx.ID_ANY, _("Step size:"))
        grid_sizer_19.Add(label_2, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)

        self.rotor_step_spin_ctrl = positioner_dialog.UsalsPosSpinCtrl(self.usals_location_panel, wx.ID_ANY, initial=0.1, min=0.0, max=5.0, style=wx.ALIGN_CENTRE_HORIZONTAL | wx.SP_ARROW_KEYS)
        ...
        grid_sizer_19.Add(self.rotor_step_spin_ctrl, 0, wx.ALIGN_CENTER_VERTICAL | wx.FIXED_MINSIZE, 0)
        ...
        grid_sizer_9.Add(self.diseqc_position_spin_ctrl, 1, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        grid_sizer_2.Add(self.signal_info_panel, 0, wx.EXPAND, 0)
