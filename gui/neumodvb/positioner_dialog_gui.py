...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.1 on Tue Mar  3 00:51:37 2026
#
...
class SignalPanel_(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        signal_panel_sizer.Add(status_sizer, (2, 0), (1, 1), 0, 0)
        ...
        signal_panel_sizer.Add(grid_sizer_16, (3, 0), (1, 1), 0, 0)
        ...
        modcod_sizer = wx.FlexGridSizer(1, 3, 0, 1)
        signal_panel_sizer.Add(modcod_sizer, (5, 0), (1, 1), wx.EXPAND, 0)

        label_17 = wx.StaticText(self, wx.ID_ANY, _("MOD:"))
        modcod_sizer.Add(label_17, 0, 0, 0)

        self.modcod_list_text = wx.StaticText(self, wx.ID_ANY, _("\n\n"))
        modcod_sizer.Add(self.modcod_list_text, 1, wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, 0)

        self.speak_toggle = wx.ToggleButton(self, wx.ID_ANY, _("Speak"))
        self.speak_toggle.SetToolTip(_("Speak and thy mouth will open"))
        modcod_sizer.Add(self.speak_toggle, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL | wx.FIXED_MINSIZE, 0)

        modcod_sizer.AddGrowableCol(1)
        ...
        signal_panel_sizer.AddGrowableRow(5)
...
class TuneMuxPanel_(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.si_freq_text.SetFont(wx.Font(7, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        ...
        self.si_symbolrate_text.SetFont(wx.Font(7, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        ...
        self.si_nit_ids_text.SetFont(wx.Font(7, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        ...
        self.si_sdt_services_text.SetFont(wx.Font(7, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        ...
        sizer_3333.Add(self.constellation_plot, 0, wx.EXPAND | wx.SHAPED, 0)
...
class PositionerDialog_(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.SetSize((1288, 897))
        self.SetTitle(_("Positioner"))

        grid_sizer_1 = wx.FlexGridSizer(3, 1, 2, 0)
        ...
        grid_sizer_4 = wx.FlexGridSizer(1, 4, 3, 10)
        ...
        grid_sizer_4.Add(self.motor_control_panel, 1, wx.ALL | wx.EXPAND, 0)
        ...
        sizer_8.Add(label_24, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.BOTTOM, 3)

        self.motor_control_type_panel = wx.Panel(self.motor_control_panel, wx.ID_ANY)
        sizer_8.Add(self.motor_control_type_panel, 1, wx.EXPAND, 0)

        sizer_5 = wx.FlexGridSizer(1, 4, 0, 2)

        label_13 = wx.StaticText(self.motor_control_type_panel, wx.ID_ANY, _("Type:"))
        label_13.SetFont(wx.Font(7, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        sizer_5.Add(label_13, 0, 0, 9)

        self.diseqc_type_choice = DiseqcChoice(self.motor_control_type_panel, wx.ID_ANY, choices=[_("Disabled"), _("USALS"), _("DISEQC2"), ""])
        ...
        sizer_5.Add(self.diseqc_type_choice, 0, 0, 10)

        sizer_5.Add((0, 0), 0, 0, 0)

        self.direct_motor_control_panel = wx.Panel(self.motor_control_panel, wx.ID_ANY)
        sizer_8.Add(self.direct_motor_control_panel, 1, wx.EXPAND, 0)
        ...
        grid_sizer_4.Add(self.diseqc12_panel, 1, wx.ALL | wx.EXPAND, 0)
        ...
        sizer_9.Add(label_19, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.BOTTOM, 3)
        ...
        grid_sizer_4.Add(self.signal_info_panel, 1, wx.ALL | wx.EXPAND, 0)
        ...
        self.motor_control_type_panel.SetSizer(sizer_5)

        self.motor_control_panel.SetSizer(sizer_8)
