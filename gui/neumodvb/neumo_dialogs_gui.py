...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.0b1 on Tue Aug 13 01:09:38 2024
#
...
class ChannelNoDialog_(wx.Dialog):
				def __init__(self, *args, **kwds):
								...
								self.chno = wx.TextCtrl(sizer_6.GetStaticBox(), wx.ID_ANY, "", style=wx.TE_MULTILINE | wx.TE_PROCESS_ENTER)
...
class LnbUnicableChannelDialog_(wx.Dialog):
				def __init__(self, *args, **kwds):
								# begin wxGlade: LnbUnicableChannelDialog_.__init__
								kwds["style"] = kwds.get("style", 0) | wx.DEFAULT_DIALOG_STYLE | wx.MAXIMIZE_BOX | wx.MINIMIZE_BOX | wx.RESIZE_BORDER | wx.STAY_ON_TOP
								wx.Dialog.__init__(self, *args, **kwds)
								self.SetSize((1200, 400))
								self.SetTitle(_("UnicableChannels"))

								sizer_1 = wx.BoxSizer(wx.VERTICAL)

								self.lnbunicablechannellist_panel = wx.Panel(self, wx.ID_ANY, style=wx.BORDER_RAISED | wx.CLIP_CHILDREN)
								sizer_1.Add(self.lnbunicablechannellist_panel, 1, wx.ALL | wx.EXPAND | wx.FIXED_MINSIZE, 0)

								self.lnbunicablechannelgrid_sizer = wx.BoxSizer(wx.VERTICAL)

								self.lnbunicablechannelgrid_sizer.Add((0, 0), 0, 0, 0)
								...
								self.lnbunicablechannellist_panel.SetSizer(self.lnbunicablechannelgrid_sizer)
				...
				def OnNew(self, event):  # wxGlade: LnbUnicableChannelDialog_.<event_handler>
								print("Event handler 'OnNew' not implemented!")
								event.Skip()

				def OnDelete(self, event):  # wxGlade: LnbUnicableChannelDialog_.<event_handler>
								print("Event handler 'OnDelete' not implemented!")
								event.Skip()

				def OnCancel(self, event):  # wxGlade: LnbUnicableChannelDialog_.<event_handler>
								print("Event handler 'OnCancel' not implemented!")
								event.Skip()

				def OnDone(self, event):  # wxGlade: LnbUnicableChannelDialog_.<event_handler>
								print("Event handler 'OnDone' not implemented!")
								event.Skip()

# end of class LnbUnicableChannelDialog_
...
class ErrorDialog_(wx.Dialog):
				def __init__(self, *args, **kwds):
								...
								self.cancel = wx.Button(sizer_4.GetStaticBox(), wx.ID_ANY, _("Cancel"))
								sizer_4.Add(self.cancel, 1, 0, 0)

								self.ok = wx.Button(sizer_4.GetStaticBox(), wx.ID_ANY, _("OK"))
