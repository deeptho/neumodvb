...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.0b1 on Sat Mar 15 15:52:21 2025
#
...
class PreferencesDialog_(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        grid_sizer_4 = wx.FlexGridSizer(5, 2, 5, 5)
        ...
        tune_use_bbframes_label = wx.StaticText(self.preferences_notebook_Tune, wx.ID_ANY, _("Use bbframes"))
        grid_sizer_4.Add(tune_use_bbframes_label, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.tune_use_bbframes = wx.CheckBox(self.preferences_notebook_Tune, wx.ID_ANY, "")
        self.tune_use_bbframes.SetToolTip(_("Ask frontend to output bbframes to demux when suppirted, allowing simultaneous use of multiple streams"))
        grid_sizer_4.Add(self.tune_use_bbframes, 0, 0, 0)
