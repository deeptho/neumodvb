...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Wed Jan 24 01:21:43 2024
#
...
class PreferencesDialog_(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.config_path = wx.TextCtrl(self.storage_pane, wx.ID_ANY, "")
        ...
        self.osd_svg = wx.TextCtrl(self.configfile_pane, wx.ID_ANY, "")
        self.osd_svg.SetMinSize((250, -1))
        self.osd_svg.SetToolTip(_("Overlay SVG file which defines decorative elements and location of various pieces of information on the live screen"))
        grid_sizer_2.Add(self.osd_svg, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        label_8 = wx.StaticText(self.configfile_pane, wx.ID_ANY, _("mpv"))
        grid_sizer_2.Add(label_8, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.mpv_config = wx.TextCtrl(self.configfile_pane, wx.ID_ANY, "")
        self.mpv_config.SetMinSize((250, -1))
        self.mpv_config.SetToolTip(_("mpv configuration file"))
        grid_sizer_2.Add(self.mpv_config, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        label_7 = wx.StaticText(self.configfile_pane, wx.ID_ANY, _("Log4cxx"))
        grid_sizer_2.Add(label_7, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.log4cxx = wx.TextCtrl(self.configfile_pane, wx.ID_ANY, "")
        self.log4cxx.SetMinSize((250, -1))
        self.log4cxx.SetToolTip(_("Location of configuration file defining debug verbosity"))
        grid_sizer_2.Add(self.log4cxx, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        self.tune_use_blin_tune_checkbox.SetToolTip(_("Use blind tune during regular tuning, and use database parameters only as a starting guess"))
        ...
        self.tune_may_move_dish_checkbox.SetToolTip(_("Move the dish if that is required to tune a service or mux. If disabled, then tune will fail instead"))
        ...
        self.scan_use_blin_tune_checkbox.SetToolTip(_("Use blind tune during user requested scanning, and use database parameters only as a starting guess"))
        ...
        self.scan_may_move_dish_checkbox.SetToolTip(_("Move the dish if that is required to scan a service or mux. If disabled, then scanning that mux will fail instead."))
        ...
        self.band_scan_save_spectrum_checkbox.SetToolTip(_("During satellite band scanning, save the spectra. When disabled, spectra are not saved"))
        ...
        self.positioner_dialog_use_blin_tune_checkbox.SetToolTip(_("Use blind tune on positioner dialog"))
