...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Tue Jan 23 23:23:35 2024
#
...
class SchedulingParameters_(wx.Panel):
				def __init__(self, *args, **kwds):
								...
								self.Bind(wx.EVT_CHOICE, self.OnRunTypeChoice, self.run_type_choice)
								# end wxGlade
...
class ScanDialog_(wx.Dialog):
				def __init__(self, *args, **kwds):
								...
								self.scan_type_choice.SetToolTip(_("What tyoe fo scan to perform"))
