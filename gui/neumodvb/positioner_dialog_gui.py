...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.0pre on Wed Jan 19 22:26:46 2022
#
...
class TuneMuxPanel_(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.si_info_panel.SetMinSize((720, -1))
...
class PositionerDialog_(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.goto_east_button = wx.Button(self.direct_motor_control_panel, wx.ID_ANY, _("Go East"))
        ...
        self.goto_west_button = wx.Button(self.direct_motor_control_panel, wx.ID_ANY, _("Go West"))
        self.goto_west_button.SetToolTip(_("Move west continously"))
        self.goto_west_button.SetBitmap(wx.ArtProvider.GetBitmap(wx.ART_GOTO_LAST, wx.ART_OTHER, (16, 16)), dir=wx.RIGHT)
        grid_sizer2.Add(self.goto_west_button, 0, wx.ALIGN_RIGHT, 0)
