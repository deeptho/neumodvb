...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.0pre on Sun Nov 21 23:27:15 2021
#
...
class SignalPanel_(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        sizer_12.Add(self.si_symbolrate_text, 0, wx.RIGHT, 5)
...
class TuneMuxPanel_(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        label_1c12 = wx.StaticText(self.panel_3, wx.ID_ANY, _("Sig:"))
        grid_sizer_7.Add(label_1c12, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.speak_toggle = wx.ToggleButton(self.panel_3, wx.ID_ANY, _("Speak"))
        self.speak_toggle.SetToolTip(_("Speak and thy mouth will open"))
        grid_sizer_7.Add(self.speak_toggle, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.FIXED_MINSIZE, 0)

        label_const = wx.StaticText(self.panel_3, wx.ID_ANY, _("Constellation:"))
        grid_sizer_7.Add(label_const, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.constellation_toggle = wx.ToggleButton(self.panel_3, wx.ID_ANY, _("Update"))
        self.constellation_toggle.SetToolTip(_("Update constellation plot"))
        grid_sizer_7.Add(self.constellation_toggle, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.FIXED_MINSIZE, 0)
        ...
        label_16 = wx.StaticText(self.info_from_tuner_panel, wx.ID_ANY, _("DVB ids:"))
        grid_sizer_15.Add(label_16, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.dvb_ids_text = wx.StaticText(self.info_from_tuner_panel, wx.ID_ANY, "")
        grid_sizer_15.Add(self.dvb_ids_text, 0, wx.ALIGN_CENTER_VERTICAL, 0)
    ...
    def OnToggleSpeak(self, event):  # wxGlade: TuneMuxPanel_.<event_handler>
...
class PositionerDialog_(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        grid_sizer_2 = wx.FlexGridSizer(1, 3, 5, 6)
        ...
        grid_sizer_2.Add(self.constellation_panel, 0, wx.EXPAND, 0)
        ...
        grid_sizer_2.Add(self.tune_mux_panel, 0, wx.EXPAND, 0)
