...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.4 on Sun Feb  5 22:51:36 2023
#
...
class PositionerDialog_(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.lnb_offset_pos_text_ctrl = wx.TextCtrl(self.usals_panel, wx.ID_ANY, _("0.0E"), style=wx.TE_CENTRE | wx.TE_PROCESS_ENTER)
        self.lnb_offset_pos_text_ctrl.SetToolTip(_("Offset of LNB on Dish relative to center"))
        self.lnb_offset_pos_text_ctrl.Bind(wx.EVT_KILL_FOCUS, self.OnLnbOffsetPosChanged)
        grid_sizer2b.Add(self.lnb_offset_pos_text_ctrl, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.FIXED_MINSIZE | wx.LEFT, 0)

        self.lnb_offset_pos_east_west_choice = wx.Choice(self.usals_panel, wx.ID_ANY, choices=[_("East"), _("West")])
        self.lnb_offset_pos_east_west_choice.SetSelection(0)
        grid_sizer2b.Add(self.lnb_offset_pos_east_west_choice, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        self.Bind(wx.EVT_TEXT_ENTER, self.OnLnbOffsetPosChanged, self.lnb_offset_pos_text_ctrl)
        self.Bind(wx.EVT_CHOICE, self.OnLnbOffsetPosEastWestSelect, self.lnb_offset_pos_east_west_choice)
        # end wxGlade
    ...
    def OnLnbOffsetPosChanged(self, event):  # wxGlade: PositionerDialog_.<event_handler>
        print("Event handler 'OnLnbOffsetPosChanged' not implemented!")
        event.Skip()

    def OnLnbOffsetPosEastWestSelect(self, event):  # wxGlade: PositionerDialog_.<event_handler>
        print("Event handler 'OnLnbOffsetPosEastWestSelect' not implemented!")
        event.Skip()
