...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.0pre on Mon Apr 18 18:13:33 2022
#
...
class SpectrumDialog_(wx.Frame):
    ...
    def OnDrawMux(self, event):  # wxGlade: SpectrumDialog_.<event_handler>
        print("Event handler 'OnDrawMux' not implemented!")
        event.Skip()
