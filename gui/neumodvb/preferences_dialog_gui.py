...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.0pre on Sun Nov 19 15:37:47 2023
#
...
class PreferencesDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        tune_may_move_dish_label = wx.StaticText(self.preferences_notebook_Tune, wx.ID_ANY, _("Alllow moving dish"))
        ...
        grid_sizer_5 = wx.FlexGridSizer(3, 2, 5, 5)
        ...
        self.checkbox_2 = wx.CheckBox(self.preferences_notebook_Scan, wx.ID_ANY, "")
        grid_sizer_5.Add(self.checkbox_2, 0, 0, 0)

        band_scan_save_spectrum_label = wx.StaticText(self.preferences_notebook_Scan, wx.ID_ANY, _("Maxumium time spent on epg scan"))
        ...
        max_scan_time_label = wx.StaticText(self.preferences_notebook_Scan, wx.ID_ANY, _("Maxumium time spent on epg scan"))
        grid_sizer_5.Add(max_scan_time_label, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.max_scan_time_text = DurationTextCtrl(self.preferences_notebook_Scan, wx.ID_ANY, _("1"))
        self.max_scan_time_text.SetMinSize((250, -1))
        self.max_scan_time_text.SetToolTip(_("Time to start recording before start of program (min or min:sec)"))
        grid_sizer_5.Add(self.max_scan_time_text, 0, wx.ALIGN_CENTER_VERTICAL, 0)
