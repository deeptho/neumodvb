...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.1 on Tue Mar  3 00:53:04 2026
#
...
class SpectrumButtons_(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        grid_sizer_5 = wx.FlexGridSizer(1, 8, 0, 3)
        sizer_2.Add(grid_sizer_5, 1, wx.EXPAND, 0)

        label_2 = wx.StaticText(self, wx.ID_ANY, _("Polarisations:"))
        grid_sizer_5.Add(label_2, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.spectrum_horizontal = wx.ToggleButton(self, wx.ID_ANY, _("H"))
        self.spectrum_horizontal.SetMinSize((40, 33))
        self.spectrum_horizontal.SetToolTip(_("(De)Select horizontal polarisation"))
        grid_sizer_5.Add(self.spectrum_horizontal, 0, wx.EXPAND, 0)

        self.spectrum_vertical = wx.ToggleButton(self, wx.ID_ANY, _("V"))
        self.spectrum_vertical.SetMinSize((40, 33))
        self.spectrum_vertical.SetToolTip(_("(De)Select vertical polarisation"))
        grid_sizer_5.Add(self.spectrum_vertical, 0, wx.EXPAND, 0)

        grid_sizer_5.Add((1, 20), 0, 0, 0)

        label_5 = wx.StaticText(self, wx.ID_ANY, _("From:"))
        grid_sizer_5.Add(label_5, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.start_freq_text = wx.TextCtrl(self, wx.ID_ANY, "")
        self.start_freq_text.SetToolTip(_("Start of frequency range to scan (Mhz)"))
        grid_sizer_5.Add(self.start_freq_text, 0, wx.ALL, 2)

        label_6 = wx.StaticText(self, wx.ID_ANY, _("To:"))
        grid_sizer_5.Add(label_6, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.end_freq_text = wx.TextCtrl(self, wx.ID_ANY, "")
        self.end_freq_text.SetToolTip(_("End of frequency range to scan (Mhz)"))
        grid_sizer_5.Add(self.end_freq_text, 0, wx.ALL, 2)
        ...
        self.acquire_spectrum.Bind(wx.EVT_TOGGLEBUTTON, self.OnAcquireSpectrum)
        self.blindscan_button.Bind(wx.EVT_TOGGLEBUTTON, self.OnBlindScan)
        # end wxGlade
...
class TuneMuxPanel_(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.Blind.Bind(wx.EVT_TOGGLEBUTTON, self.OnToggleBlindscan)
...
class SpectrumListPanel_(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        label_22 = wx.StaticText(self, wx.ID_ANY, _("Spectra"))
        label_22.SetFont(wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        label_22.SetToolTip(_("Display  previously captured spectra"))
...
class SpectrumDialog_(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        grid_sizer_3 = wx.FlexGridSizer(1, 1, 0, 5)
        ...
        grid_sizer_4.Add(self.signal_panel, 1, 0, 5)

        self.spectrum_buttons_panel = spectrum_dialog.SpectrumButtons(self, wx.ID_ANY)
        grid_sizer_1.Add(self.spectrum_buttons_panel, 1, wx.EXPAND, 0)

        self.tune_mux_panel = positioner_dialog.TuneMuxPanel(self, wx.ID_ANY)
        grid_sizer_2.Add(self.tune_mux_panel, 2, wx.ALL | wx.EXPAND, 4)
