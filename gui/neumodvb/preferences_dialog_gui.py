...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.0pre on Fri Aug 13 17:57:26 2022
#
...
class PreferencesDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.config_path = wx.TextCtrl(self.storage_pane, wx.ID_ANY, _("~/.config/neumodvb/config"))
        ...
        self.options_pane = wx.Panel(self.preferences_notebook, wx.ID_ANY)
        self.preferences_notebook.AddPage(self.options_pane, _("Options"))

        grid_sizer_3 = wx.FlexGridSizer(8, 2, 5, 5)

        label_9 = wx.StaticText(self.options_pane, wx.ID_ANY, _("Default record time"))
        grid_sizer_3.Add(label_9, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.default_record_time_text = wx.TextCtrl(self.options_pane, wx.ID_ANY, _("120"))
        ...
        label_10 = wx.StaticText(self.options_pane, wx.ID_ANY, _("Pre-record time"))
        grid_sizer_3.Add(label_10, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.pre_record_time_text = wx.TextCtrl(self.options_pane, wx.ID_ANY, _("1"))
        ...
        label_11 = wx.StaticText(self.options_pane, wx.ID_ANY, _("Post-record time"))
        grid_sizer_3.Add(label_11, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.post_record_time_text = wx.TextCtrl(self.options_pane, wx.ID_ANY, _("5"))
        ...
        label_11 = wx.StaticText(self.options_pane, wx.ID_ANY, _("Timeshift duration"))
        grid_sizer_3.Add(label_11, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.timeshift_duration_text = wx.TextCtrl(self.options_pane, wx.ID_ANY, _("120"))
        ...
        label_11 = wx.StaticText(self.options_pane, wx.ID_ANY, _("Timeshift buffer retention"))
        grid_sizer_3.Add(label_11, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.timeshift_retention_text = wx.TextCtrl(self.options_pane, wx.ID_ANY, _("5"))
        ...
        label_11 = wx.StaticText(self.options_pane, wx.ID_ANY, _("Timeshift resolution"))
        grid_sizer_3.Add(label_11, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.timeshift_resolution_text = wx.TextCtrl(self.options_pane, wx.ID_ANY, _("5"))
        ...
        self.options_pane.SetSizer(grid_sizer_3)
