...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.0pre on Wed Nov 22 23:20:24 2023
#
...
class ScanDialog_(wx.Dialog):
				def __init__(self, *args, **kwds):
								...
								sizer_3 = wx.FlexGridSizer(12, 1, 0, 0)
								...
								label_1 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Range (MHz)"))
								grid_sizer_1.Add(label_1, 0, 0, 0)

								self.start_freq_textctrl = DtIntCtrl(self.panel_1, wx.ID_ANY, _("-1"))
								self.start_freq_textctrl.SetToolTip(_("Start of frequency range to scan (Mhz)\nLeave blank to allow any"))
								grid_sizer_1.Add(self.start_freq_textctrl, 1, wx.ALL, 2)

								self.end_freq_textctrl = DtIntCtrl(self.panel_1, wx.ID_ANY, _("-1"))
								self.end_freq_textctrl.SetToolTip(_("End of frequency range to scan (Mhz)\nLeave blank to allow any."))
								grid_sizer_1.Add(self.end_freq_textctrl, 1, wx.ALL, 2)
